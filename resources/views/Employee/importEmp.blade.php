...
<div class="panel-body">
        <form action="{{ url('empFileImport') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-heading">
		<h3>Employee Import Interface</h3>
	  </div>
      ...
      <div class="panel-body">
        ...
        <form action="{{ url('empFileUpload') }}" method="POST" enctype="multipart/form-data">
