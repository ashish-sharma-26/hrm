...
<div class="loader"></div>
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{url('registeredConsultancy')}}"><img src="{{ asset('hrm/images/logo.png')}}"></a>
                </div>
      ...
      <ul class="nav navbar-nav">
					<li><a href="{{url('registeredConsultancy')}}">Dashboard</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="{{url('manageResume')}}"><i class="fa fa-user fa-fw"></i> Manage Resume</a>
                ...
                <ul class="nav navbar-right navbar-top-links">
                    <li class="dropdown navbar-inverse">
                        ...
                        <ul class="dropdown-menu dropdown-alerts">
                           ...
                           <x-Header.NotificationLists></x-Header.NotificationLists>
            ...
            <div class="gradient-border-bottom">
              <div class="gradient-border">
                    ...
                    <div><a href="{{url('registeredConsultancy')}}">Dashboard</a></div>                        
                    <div class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            Recruitment<b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
						<li>
							<a href="{{url('manageResume')}}"><i class="fa fa-user fa-fw"></i> Manage Resume</a>
						</li>
